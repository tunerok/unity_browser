...
// Type: MimeTypes.MimeTypeMap
// Assembly: MimeTypeMap, Version=2.1.0.0, Culture=neutral, PublicKeyToken=null
// MVID: C6635A19-39AE-4AA4-8FDD-4B60B62F9174
// Assembly location: D:\Projects\Engine room\packages\MediaTypeMap.2.1.0.0\lib\net40\MimeTypeMap.dll
...
namespace MimeTypes
{
  ...
  {
    private static Dictionary<string, string> source = new Dictionary<string, string>(StringComparer.InvariantCultureIgnoreCase)
      {
        {
          ".323",
          "text/h323"
    ...
    public static string GetMimeType(string extension)
    {
      ...
      if (!extension.StartsWith("."))
        extension = "." + extension;
      string str;
      if (!source.TryGetValue(extension, out str))
    ...
    public static string GetExtension(string mimeType)
    {
      ...
      string str;
      if (source.TryGetValue(mimeType, out str))
        return str;
